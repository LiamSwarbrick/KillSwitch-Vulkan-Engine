...
//     RESOURCE_TYPE_SHADER_BYTECODE,
    ...
    */
    ...
    Asset* room_prefab = scene.LoadPrefab("assets/levels/testroom_newest.gltf");
    ...
    EntityID playerID = scene.InstantiatePrefab(player, glm::vec3(0, 0, 2), glm::identity<glm::quat>());
    scene.InstantiatePrefab(zombie_woman, glm::vec3(0, 0, -1), Math::ViewDirToQuat({0.0f ,0.0f, 1.0f}));
    scene.InstantiatePrefab(zombie_woman, glm::vec3(0.8, 0, -2.1), Math::ViewDirToQuat({ 0.0f ,0.0f, 1.0f }));
    scene.InstantiatePrefab(zombie_woman, glm::vec3(-0.8, 0, -2.1), Math::ViewDirToQuat({ 0.0f ,0.0f, 1.0f }));
    scene.InstantiatePrefab(zombie_woman, glm::vec3(-1.6, 0, -3.2), Math::ViewDirToQuat({ 0.0f ,0.0f, 1.0f }));
    scene.InstantiatePrefab(zombie_woman, glm::vec3( 1.6, 0, -3.2), Math::ViewDirToQuat({ 0.0f ,0.0f, 1.0f }));
    scene.InstantiatePrefab(zombie_woman, glm::vec3(0, 0, -3.2), Math::ViewDirToQuat({ 0.0f ,0.0f, 1.0f }));
